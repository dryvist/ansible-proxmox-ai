...
* **llama_cpp:** enable llama-server's Prometheus metrics endpoint ([31a7628](https://github.com/dryvist/ansible-proxmox-ai/commit/31a7628d0da829ee5dd6c686ed530cd5c26c1be4))
* **llama_cpp:** enable llama-server's Prometheus metrics endpoint ([46f23c2](https://github.com/dryvist/ansible-proxmox-ai/commit/46f23c22856c3f0059400e32e02a172b69fc88d4))
* **llm_router:** 15-second admission budget and a guaranteed ladder ([9306218](https://github.com/dryvist/ansible-proxmox-ai/commit/93062188c40941b73b8c78bfea02a6b4a8e1b8ba))
* **llm_router:** 15-second admission budget and a guaranteed ladder ([c4aeab8](https://github.com/dryvist/ansible-proxmox-ai/commit/c4aeab8de2f1720c7c679a995832b7854d9f2e6e))
* **llm_router:** emit structured per-request event for review latency ([60b4fc1](https://github.com/dryvist/ansible-proxmox-ai/commit/60b4fc109cd1bd4bbfc4104c50a8ac2d7ea749c0))
* **llm_router:** emit structured per-request event for review latency ([26da54f](https://github.com/dryvist/ansible-proxmox-ai/commit/26da54fc32ef14ae7efffd71e06203055bea82aa))
* **llm_router:** gate router_settings seeding on llm_router_seed_mode ([9717d96](https://github.com/dryvist/ansible-proxmox-ai/commit/9717d965c88d491e85df15832f41fd64c1a2de88))
* **llm_router:** gate router_settings seeding on llm_router_seed_mode ([aa5a05d](https://github.com/dryvist/ansible-proxmox-ai/commit/aa5a05db1b25cb435dfcae3b559667863d810418))
* **llm_router:** gate the public CI key and its KV path behind one switch ([22414a3](https://github.com/dryvist/ansible-proxmox-ai/commit/22414a3119bb9e1829760b8dc2856d385385f3e9))
* **llm_router:** gate the public CI key and its KV path behind one switch ([5a1003c](https://github.com/dryvist/ansible-proxmox-ai/commit/5a1003c5e74ea88d966f88712af4f46265b05f0f))
* **llm_router:** review roles, Codex rungs, and the Z.ai overflow pair ([48e20cc](https://github.com/dryvist/ansible-proxmox-ai/commit/48e20ccdf3c6c144375f4adfb06b294f724b4289))
* **llm_router:** review roles, Codex rungs, and the Z.ai overflow pair ([aaf0f70](https://github.com/dryvist/ansible-proxmox-ai/commit/aaf0f708c47616525eca9e8bc592dde7c1b8aebe))
* **llm_router:** seed cheap on the GPU rung first, bounded per rung ([2bb4350](https://github.com/dryvist/ansible-proxmox-ai/commit/2bb4350e2a6a7b0ffee951a55fa3223112513e51))
* **llm_router:** seed cheap on the GPU rung first, bounded per rung ([7ec7979](https://github.com/dryvist/ansible-proxmox-ai/commit/7ec79797a22d3abb6a4fa905d709e0a3bd44c46c))


### Bug Fixes

* **ci:** cache Galaxy collections in the data-contract and llm-router-contract workflows ([540cdf6](https://github.com/dryvist/ansible-proxmox-ai/commit/540cdf69ea5b9128805c77d5fe891b6f7a6b4da9))
* **ci:** cache Galaxy collections in the data-contract and llm-router-contract workflows ([e2f6560](https://github.com/dryvist/ansible-proxmox-ai/commit/e2f6560b80c7c180be8e82f8e0d2c54dd332930c))
* **ci:** cache Galaxy collections in the Molecule workflow ([63da2b6](https://github.com/dryvist/ansible-proxmox-ai/commit/63da2b636654ae54ce3d82d9babf54d666b57e4d))
* **ci:** cache Galaxy collections in the Molecule workflow ([0bbafb1](https://github.com/dryvist/ansible-proxmox-ai/commit/0bbafb1b0cb92e34312639420fb7c63ad001933a))
* **ci:** matrix the llm-router-contract playbooks instead of a second file ([5f5f8bb](https://github.com/dryvist/ansible-proxmox-ai/commit/5f5f8bb4210c0eb101b526d686e93d6fe0e390f0))
* **ci:** move the Redis service and REQUIRE_REDIS flag to the job that needs it ([5d5a99a](https://github.com/dryvist/ansible-proxmox-ai/commit/5d5a99a233ccc41bb48614f88c9a7f4687f9aca3))
* **ci:** move the stale redis/pytest comment to the job it now describes ([2396538](https://github.com/dryvist/ansible-proxmox-ai/commit/23965381a6b16b630ce8241f53ec6270b569a3bc))
* **ci:** split llm-router contract workflow under the token-limit ceiling ([9de319f](https://github.com/dryvist/ansible-proxmox-ai/commit/9de319f3a7a07a9f1d46e7a9af8fce8946ee31b2))
* **ci:** split llm-router-contract workflow to clear the token budget ([7560129](https://github.com/dryvist/ansible-proxmox-ai/commit/7560129cdd838708213e1e5887832580bb2360ce))
* **ci:** split llm-router-contract workflow to clear the token budget ([f4c4c87](https://github.com/dryvist/ansible-proxmox-ai/commit/f4c4c87c66f3922a34853c918cec702615bef63e))
* **ci:** wrap matrix entries over ansible-lint's 120-char line limit ([aef49c9](https://github.com/dryvist/ansible-proxmox-ai/commit/aef49c99281e895e02b88fb751a61fd5db0ce2fd))
* **llama_cpp:** make llama_cpp_parallel mandatory via a single template filter ([0be7aee](https://github.com/dryvist/ansible-proxmox-ai/commit/0be7aeec5fe5212842e80f556fceefe1333d7d63))
* **llama_cpp:** make llama_cpp_parallel mandatory via a single template filter ([825d101](https://github.com/dryvist/ansible-proxmox-ai/commit/825d1011fb75480ccb44aba21c3a1e4fb3723b8e))
* **llama_cpp:** reject when the slot is busy instead of queueing ([b5c1e44](https://github.com/dryvist/ansible-proxmox-ai/commit/b5c1e4405693278a62143a977318e1769ca6822e))
* **llama_cpp:** reject when the slot is busy instead of queueing ([8c21362](https://github.com/dryvist/ansible-proxmox-ai/commit/8c2136213ecdc20a9b9b871b9fdc700d2e87bd24))
* **llama_cpp:** render concurrencyLimit at the model level ([b52efe5](https://github.com/dryvist/ansible-proxmox-ai/commit/b52efe5302322f80c07ba60eccaf8c5af792936b))
* **llama_cpp:** retire the live llama-swap unit ([542c1cc](https://github.com/dryvist/ansible-proxmox-ai/commit/542c1cc6ab41975f5949becf6c8bd219ba44327f))
* **llama_cpp:** retire the live llama-swap unit ([000fa4b](https://github.com/dryvist/ansible-proxmox-ai/commit/000fa4b43c4bae9761778872e42885603634ef74))
* **llm_router:** append the paid terminal to review-oss's chain ([a92f4e3](https://github.com/dryvist/ansible-proxmox-ai/commit/a92f4e3b1ad9e3ecbd830578731635440a1495a9))
* **llm_router:** bound every local rung's non-streaming timeout ([0d71987](https://github.com/dryvist/ansible-proxmox-ai/commit/0d71987f4aa57a4e1b8f16b465cf6a7e0607938d))
* **llm_router:** bound every local rung's non-streaming timeout ([355d53c](https://github.com/dryvist/ansible-proxmox-ai/commit/355d53c0636d4aeabff75c535c0226a90c62d398))
* **llm_router:** bound the first byte below the ingress cut, budget the retries ([849ac0c](https://github.com/dryvist/ansible-proxmox-ai/commit/849ac0c2e2d721bb36b7caef9be13badc359590d))
* **llm_router:** clamp role deployment timeout and window to base vars ([#843](https://github.com/dryvist/ansible-proxmox-ai/issues/843)) ([f41e94f](https://github.com/dryvist/ansible-proxmox-ai/commit/f41e94f44fc4e2139e4d8ce993b023e15087c3c3))
* **llm_router:** disable the unserved coder entry and pin card entries to llama-swap ([27b8144](https://github.com/dryvist/ansible-proxmox-ai/commit/27b8144ba79e748f97f3455204e0eeff17cf27c4))
* **llm_router:** disable the unserved coder entry and pin card entries to llama-swap ([333d60f](https://github.com/dryvist/ansible-proxmox-ai/commit/333d60f4295539a41bf58418092f5b5147034989))
* **llm_router:** emit max_input_tokens as an int, not a folded string ([11d2746](https://github.com/dryvist/ansible-proxmox-ai/commit/11d2746c97b60dabf8b909acd710173aebfe58bc))
* **llm_router:** emit ZAI_API_KEY into the LiteLLM environment ([d4de815](https://github.com/dryvist/ansible-proxmox-ai/commit/d4de815363f78f635c4041c527e329a97086005a))
* **llm_router:** emit ZAI_API_KEY into the LiteLLM environment ([6e124da](https://github.com/dryvist/ansible-proxmox-ai/commit/6e124da404d04afb7cb0574d0c428f2c26f01d2d))
* **llm_router:** express local-first as fallback order, not group membership ([f8ae725](https://github.com/dryvist/ansible-proxmox-ai/commit/f8ae725b9c8fada405783b25ed655b89afa18933))
* **llm_router:** express local-first as fallback order, not group membership ([1de67b6](https://github.com/dryvist/ansible-proxmox-ai/commit/1de67b6f60b52c5d4a7ad6e041da122456caa01a))
* **llm_router:** give review-oss's ladder an escape past the Z.ai pair ([6fd97d6](https://github.com/dryvist/ansible-proxmox-ai/commit/6fd97d66d27ac6eca7d0a7548f6b57c673957e7b))
* **llm_router:** grant seeded model names to live keys that lack them ([#804](https://github.com/dryvist/ansible-proxmox-ai/issues/804)) ([5ea4963](https://github.com/dryvist/ansible-proxmox-ai/commit/5ea496306e268f53ccbb2f07bc0cab8adc8bb349))
* **llm_router:** keep the callbacks note a YAML comment so the key stays at mapping depth ([70b4ac9](https://github.com/dryvist/ansible-proxmox-ai/commit/70b4ac97b03b4499b2825d7432460ee664981697))
* **llm_router:** keep the GPU entry name out of the role-params value ([7e04e76](https://github.com/dryvist/ansible-proxmox-ai/commit/7e04e76ed0a6a6da5435420738bcdbf86edacf6b))
* **llm_router:** keep the long-context escape to fast and subagent ([3423dd3](https://github.com/dryvist/ansible-proxmox-ai/commit/3423dd3ecc23d8132493b7970daa8ead3c455ce5))
* **llm_router:** litellm 1.102.0 with fallback model-access enforcement ([#845](https://github.com/dryvist/ansible-proxmox-ai/issues/845)) ([f545d7a](https://github.com/dryvist/ansible-proxmox-ai/commit/f545d7a123e75ffd5eda93e285cce7512f0e1a4a))
* **llm_router:** make the non-streaming timeout the router's own base var ([ce179d0](https://github.com/dryvist/ansible-proxmox-ai/commit/ce179d090864006aa2a854dd4d25e69b5be104b8))
* **llm_router:** render litellm callbacks as a YAML list, not a string ([1f11fdf](https://github.com/dryvist/ansible-proxmox-ai/commit/1f11fdffabd7ec060af68730b42da7aef1a2fcb2))
* **llm_router:** render litellm callbacks as a YAML list, not a string ([940a1c6](https://github.com/dryvist/ansible-proxmox-ai/commit/940a1c6174e829aedc455d280ec11ca337efd2bd))
* **llm_router:** render the syslog route before any serving state changes ([abad0c2](https://github.com/dryvist/ansible-proxmox-ai/commit/abad0c22144df8fda5bb758f2245e3ea59497102))
* **llm_router:** resolve ansible-lint and token-limit CI failures ([191203d](https://github.com/dryvist/ansible-proxmox-ai/commit/191203d52dbf3cf408d0e26fd9c89ea8dc379f90))
* **llm_router:** run the router-settings DB sync after the restart ([f84806b](https://github.com/dryvist/ansible-proxmox-ai/commit/f84806bb8207227fcafec22a74afa4b8925fd19c))
* **llm_router:** run the router-settings DB sync after the restart ([f1c053e](https://github.com/dryvist/ansible-proxmox-ai/commit/f1c053ee0037ad4c08d8d34e5968a6368f51d75f))
* **llm_router:** run the syslog route as its own play after the pool converge ([a6a5f0d](https://github.com/dryvist/ansible-proxmox-ai/commit/a6a5f0d086737d330ff9d46add2cabf3ff486e43))
* **llm_router:** run the syslog route as its own play after the pool converge ([ab39cb1](https://github.com/dryvist/ansible-proxmox-ai/commit/ab39cb1a8a6ce9ea37285b5d4699f97a4bcd56e6))
* **llm_router:** take the free cloud rungs out of every ladder ([4b8ac18](https://github.com/dryvist/ansible-proxmox-ai/commit/4b8ac188802234002f4800581468d38dc2db2e46))
* **llm_router:** take the free cloud rungs out of every ladder ([2c3ddd9](https://github.com/dryvist/ansible-proxmox-ai/commit/2c3ddd9e27ea49bf4db5daa1fd9ceedd5aa7b371))
* **llm_router:** use include_tasks so handler notify names actually resolve ([40ee08c](https://github.com/dryvist/ansible-proxmox-ai/commit/40ee08ce9f90d421bfe69082d189fab5f9fde2dd))
* **llm-router:** point the zai tier at the GLM Coding Plan endpoint ([d3831f9](https://github.com/dryvist/ansible-proxmox-ai/commit/d3831f92a9593cdccc7a90a3b5264c5ae6375746))
* **llm-router:** point the zai tier at the GLM Coding Plan endpoint ([16144f4](https://github.com/dryvist/ansible-proxmox-ai/commit/16144f499ac3248969cda365193ff2dd395f089d))
* **tests:** retype scan ignores dict-literal key position ([298c409](https://github.com/dryvist/ansible-proxmox-ai/commit/298c409910b2e56b193f9a4c33561888187cc4a9))
* **tests:** wrap long assert strings over ansible-lint's 120-char limit ([f4ce956](https://github.com/dryvist/ansible-proxmox-ai/commit/f4ce956c52a9839b24b69fd360739e758bb984d0))
